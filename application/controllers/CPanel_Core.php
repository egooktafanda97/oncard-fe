...
class CPanel_Core extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/index.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
        }
    }
    ...
    public function AbsenKelas()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/absen_kelas.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function SyncPage()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            // $this->load->view('o_core/sinkronisasi_datasiswa_oncard_to_o_core/index.php', $data);
            $this->load->view('o_core/sinkronisasi_datasiswa_oncard_to_o_core/index_new.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function SyncPageGeneral()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/navigation.php', $data);
            // $this->load->view('o_core/sinkronisasi_datasiswa_oncard_to_o_core/index.php', $data);
            $this->load->view('o_core/sinkronisasi_datageneral_oncard_to_o_core/index_new.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function TahunAkademik()
    {
        if ($this->session->userdata('_token')) {
            ...
            // if($idData!=''){
            //     $this->load->view('o_core/o_core/modify_tahun_akademik.php', $data);
            // }else {
            //     $this->load->view('o_core/o_core/tahun_akademik.php', $data);
            // }
    ...
    public function Semester()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/semester.php', $data);
    ...
    public function Kelas()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/kelas.php', $data);
    ...
    public function SubKelas()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/sub_kelas.php', $data);
    ...
    public function ManageKelasSiswa()
    {
        if ($this->session->userdata('_token')) {
            ...
            $role = $this->session->userdata('_permission');
            $function = 'CPanel_Core';
            $pageTitle = 'Kelola Kelas Siswa';

            $idData2 = $this->uri->segment(3);
            $idData = $this->uri->segment(4);
            ...
            $this->load->view('o_core/o_core/manage_kelas_siswa.php', $data);
    ...
    public function MataPelajaran()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/matapelajaran.php', $data);
    ...
    public function Siswa()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/siswa.php', $data);
    ...
    public function General()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/general.php', $data);
    ...
    public function JadwalGuru()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/jadwal_guru.php', $data);
    ...
    public function KategoriAbsen()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/kategori_absen.php', $data);
    ...
    public function HistoriAbsensi()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/riwayat_absen.php', $data);
    ...
    public function HistoriAbsensiDev()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/riwayat_absen_dev.php', $data);
    ...
    public function HistoriAbsensiKelengkapan()
    {
        if ($this->session->userdata('_token')) {
            ...
            $role = $this->session->userdata('_permission');
            $function = 'CPanel_Core';
            $pageTitle = 'Riwayat Absen Kelengkapan';
            ...
            $organisasiID = $this->session->userdata('_organisasi_id');
            ...
            $data['function'] = $function;
            $data['pageTitle'] = $pageTitle;
            $data['waktu_keterlambatan'] = $waktu_keterlambatan;
            $data['namaLengkap'] = $this->session->userdata('_user');
            $data['_instansi_name'] = $this->session->userdata('_instansi_name');
            ...
            $this->load->view('o_core/o_core/riwayat_absen_kelengkapan.php', $data);
    ...
    public function HistoriAbsensiKelengkapanDev()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/riwayat_absen_kelengkapan_dev.php', $data);
    ...
    public function BukuBatas()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/buku_batas.php', $data);
    ...
    public function KeteranganAbsen()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/o_core/keterangan_absen.php', $data);
    ...
    public function ManageTagihan()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/o_core/manage_tagihan.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function AddModifyTagihan()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/o_core/manage_tagihan_manage.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function TagihanByJenis()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/o_core/manage_tagihan_by_jenis.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function TagihanSiswaByNIS()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/siswa/manage_tagihan_siswa_by_nis.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function PelajarPage()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/siswa/index.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function ListTunggakan()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/o_core/list_tunggakan.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function ListSeluruhTagihan()
    {
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/o_core/list_pembayaran_tagihan.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            // $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/agency/___render_kartu_apps.php', $data);
            // $this->load->view('o_core/agency/___render_kartu_pmak.php', $data);
            // $this->load->view('o_core/agency/___render_kartu_smanpintar.php', $data);
            // $this->load->view('o_core/agency/___render_kartu_ppdi.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            // $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/agency/___render_kartu.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/agency/warehouse_management.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            if($uidSetted=='1f3ade3e-5a26-4018-8a97-a8a00919ba85' || $uidSetted=='c45a75db-8e85-42a0-a319-cd88b45be75e' || $uidSetted=='b865730e-4005-48b4-9011-163651ab1415'|| $uidSetted=='dfc7d58d-1899-419b-a0da-cf70372e79bb' || $uidSetted=='c1018983-c245-436e-89a6-a34b2c969252'){
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/template/navigation_wapage.php', $data);
                $this->load->view('o_core/o_core/whatsapp_panel.php', $data);
                $this->load->view('o_core/template/footer.php', $data);
            }else {
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/agency/whatsapp_panel_error.php', $data);
                $this->load->view('o_core/template/footer.php', $data);
            }
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            if($uidSetted=='1f3ade3e-5a26-4018-8a97-a8a00919ba85' || $uidSetted=='c45a75db-8e85-42a0-a319-cd88b45be75e' || $uidSetted=='b865730e-4005-48b4-9011-163651ab1415'|| $uidSetted=='dfc7d58d-1899-419b-a0da-cf70372e79bb' || $uidSetted=='c1018983-c245-436e-89a6-a34b2c969252'){
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/template/navigation_wapage.php', $data);
                $this->load->view('o_core/agency/whatsapp_panel_testKirim.php', $data);
                $this->load->view('o_core/template/footer.php', $data);
            }else {
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/agency/whatsapp_panel_error.php', $data);
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            if($uidSetted=='1f3ade3e-5a26-4018-8a97-a8a00919ba85' || $uidSetted=='c45a75db-8e85-42a0-a319-cd88b45be75e' || $uidSetted=='b865730e-4005-48b4-9011-163651ab1415'|| $uidSetted=='dfc7d58d-1899-419b-a0da-cf70372e79bb'|| $uidSetted=='c1018983-c245-436e-89a6-a34b2c969252'){
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/template/navigation_wapage.php', $data);
                $this->load->view('o_core/agency/whatsapp_panel_createsession.php', $data);
                $this->load->view('o_core/template/footer.php', $data);
            }else {
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/agency/whatsapp_panel_error.php', $data);
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            if($uidSetted=='1f3ade3e-5a26-4018-8a97-a8a00919ba85' || $uidSetted=='c45a75db-8e85-42a0-a319-cd88b45be75e' || $uidSetted=='b865730e-4005-48b4-9011-163651ab1415'|| $uidSetted=='dfc7d58d-1899-419b-a0da-cf70372e79bb'|| $uidSetted=='c1018983-c245-436e-89a6-a34b2c969252'){
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/template/navigation_wapage.php', $data);
                $this->load->view('o_core/agency/whatsapp_panel_bulkmessage.php', $data);
                $this->load->view('o_core/template/footer.php', $data);
            }else {
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/agency/whatsapp_panel_error.php', $data);
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            if($uidSetted=='df87596a-bfc8-4584-9660-cd089d942e44' || $uidSetted=='b865730e-4005-48b4-9011-163651ab1415'){
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/template/navigation_wapage.php', $data);
                $this->load->view('o_core/whatsapp_panel_bulkmessage_broadcast.php', $data);
                $this->load->view('o_core/template/footer.php', $data);
            }else {
                $this->load->view('o_core/template/header.php', $data);
                $this->load->view('o_core/o_core/whatsapp_panel_error.php', $data);
                $this->load->view('o_core/template/footer.php', $data);
            }
    ...
    { //KHUSUS UNTUK CETAK KARTU SAJA!
        if ($this->session->userdata('_token')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            // $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/agency/___render_kartu_general.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Profil()
    {
        if ($this->session->userdata('_token') && ($this->session->userdata('_permission')=='agency'||$this->session->userdata('_permission')=='seller')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/_all/pengaturan.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Agensi()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='owner') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/agensi_page.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function IpaymuPanel()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='owner') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/ipaymu_page.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function IpaymuCreateInvoice()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='owner') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/ipaymu_page_create_invoice.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function IpaymuHistoryInvoice()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='owner') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/ipaymu_page_history_invoice.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function IpaymuPanelDetail()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='owner') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/ipaymu_page_detail.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function tambahAgensi()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='owner') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/agensi_add.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function SiswaOld()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/siswa_list.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function SiswaAllRender()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/siswa_list_all.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    //         $this->load->view('o_core/template/header.php', $data);
    //         $this->load->view('o_core/template/navigation.php', $data);
    //         $this->load->view('o_core/general_list.php', $data);
    //         $this->load->view('o_core/template/footer.php', $data);
    //     } else {
    //         $data['levelUser'] = "";
    //         $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Membership()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/membership_list.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function creditManage()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/credit_card_list.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function GeneralAllRender()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/general_list_all.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function MembershipAllRender()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/membership_list_all.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function WD()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/withdrawal.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function WDStakeHolders()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/WD_Stakeholder.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function sector_a()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/owner/rangkuman_balance.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
    ...
    public function DownloadModules()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/download_modules.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function SebaranSaldo()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/sebaran_saldo.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Merchant()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/kantin_list.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function siswaManage()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/siswa_add.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function generalManage()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/general_add.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function membershipManage()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/membership_add.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function kantinManage()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/kantin_add.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Saldo()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/riwayat_list.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Mutasi_Transaksi_Siswa()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/mutasi_transaksi.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function PrintStruk()
    {
        if ($this->session->userdata('_token')) {
            ...
            $data['namaLengkap'] = $this->session->userdata('_user');
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/_all/printstruk.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
        }
    ...
    public function PrintStrukAuto()
    {
        if ($this->session->userdata('_token')) {
            ...
            $data['namaLengkap'] = $this->session->userdata('_user');
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/_all/printstruk_auto.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
        }
    ...
    public function Mutasi_Transaksi_General()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/mutasi_transaksi_general.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Mutasi_Transaksi_Kantin()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='agency') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/mutasi_transaksi_kantin.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Mutasi_Withdrawal()
    {
        if ($this->session->userdata('_token') && ($this->session->userdata('_permission')=='agency'||$this->session->userdata('_permission')=='seller')) {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/_all/mutasi_withdrawal.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Transaksi()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='seller') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/transaksi.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function TransaksiTrial()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='seller') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/transaksi_trial.php', $data); //transaksi tanpa logic free adminfee <=2000 rupiah
            // $this->load->view('o_core/transaksi_hold.php', $data); //transaksi akan di freeze dulu halamannya dengan "UNDERMAINTANANCE"
            
            // $this->load->view('o_core/transaksi_trial_new.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function Produk()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='seller') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/product_list.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function NominalList()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='seller') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/nominal_list.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function NominalListManage()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='seller') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/nominal_add.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    public function produkManage()
    {
        if ($this->session->userdata('_token') && $this->session->userdata('_permission')=='seller') {
            ...
            $this->load->view('o_core/template/header.php', $data);
            $this->load->view('o_core/template/navigation.php', $data);
            $this->load->view('o_core/product_add.php', $data);
            $this->load->view('o_core/template/footer.php', $data);
        } else {
            $data['levelUser'] = "";
            $this->load->view('loginregister_core/login.php', $data);
    ...
    {
            $this->load->view('o_core/_pesan_otomatis/broadcast_saldo_info.php');   
    }
