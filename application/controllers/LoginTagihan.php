...
class LoginTagihan extends CI_Controller {
	...
	public function index(){   
        ...
        $data['errormsg'] = "";    
        redirect('CPanel_Tagihan/index', 'refresh');
        }else{
        $data['errormsg'] = "";
        $this->load->view('loginregister_tagihan/login',$data); 
        }
    }

    public function loginByPass(){   
        $data['errormsg'] = "";
          $this->load->view('loginregister_tagihan/login_bypass',$data);
    }
  ...
  public function loginActions()
  {
      ...
      $_url = 'https://api.management-tagihan.oncard.id/api/auth';
  ...
  function logoutUser(){
    ...
    session_destroy();
    redirect('LoginTagihan/index', 'refresh');
  }
