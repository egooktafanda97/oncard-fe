			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content"  style="border:none!important;">
					<div class="modal-header" style="border:none!important;">
                        ...
                        <div>
                        <button type="button" onclick="window.location.href='<?=base_url();?>CPanel_Admin';" class="btn btn-sm btn-outline-secondary me-2" style="font-weight:800;"><i class="bx bx-home-circle" style="margin-right:0px!important;"></i> To Dashboard</button>
                        <button type="button" id="modeset_id" class="btn btn-sm btn-secondary me-2" style="font-weight:800;"><i class="bx bx-search" style="margin-right:0px!important;"></i></button>
                    ...
                    <font class="px-3" style="display:block; text-align:center; margin:auto; font-size:8px; padding:5px; background:#f2f2f2; border-radius:100px; margin-bottom:10px; margin-top:-30px;">v.21.1</font>
				</div>
			</div>
		</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content"  style="border:none!important;">
					...
					<div class="modal-body text-center" style="border:none!important;" onclick="putFocusScanCard5();" >
						...
						<!-- <img id="scanCard5" src="<?=base_url();?>assets_oncard/images/scan_kard2.webp"  style="width:200px;  margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px;"/>
			...
			<div class="modal-dialog modal-dialog-centered" style="border:none!important;">
				<div class="modal-content" style="border:none!important;">
					...
					<div class="modal-body" style="border:none!important;">
						...
						<p class="text-center" id="textIndicator2" onclick="putfocusTotextToCard2();" style="margin:auto; transform:scale(1);transition:all 0.2s linear 0s;padding:5px; padding-left:25px; padding-right:25px; font-size:14px; border-radius:100px; background:#53edaa; color:#fff;">PIN</p>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <small style="font-size:21px; font-weight:900;" class="text-success">${formatRupiah(saldopembeli)}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
...
z-index: -1;font-weight:600;">
			...
			$("#textToCard").focus(function(){
				...
				$('#textIndicator').html('Alat scan ready!');
				$('#scanCard').attr('style','border:5px solid #53edaa;width:200px;  margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px; transition:all 0.2s linear 0s;');
			});
			$('#textToCard').blur(function(){
				...
				$('#scanCard').attr('style','width:200px;  margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px; transition:all 0.2s linear 0s;');
            ...
            $("#textToCard3").focus(function(){
				...
				$('#scanCard3').attr('style','border:5px solid #53edaa;width:200px; padding:10px; margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px; transition:all 0.2s linear 0s;');
			});
            ...
            $("#textToCard4").focus(function(){
				...
				$('#scanCard4').attr('style','border:5px solid #53edaa;width:200px;  margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px; transition:all 0.2s linear 0s;');
			});
            ...
            function putFocusScanCard4(){
				$('#textToCard4').focus();
				$('#scanCard4').attr('style','border:5px solid #53edaa;width:200px;padding:10px;  margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px; transition:all 0.2s linear 0s;');
			}
            ...
            $("#textToCard5").focus(function(){
				...
				$('#scanCard5').attr('style','border:5px solid #53edaa;width:200px;  margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px; transition:all 0.2s linear 0s;');
			});
            ...
            function putFocusScanCard5(){
				$('#textToCard5').focus();
				$('#scanCard5').attr('style','border:5px solid #53edaa;width:200px;padding:10px;  margin:auto; border-radius:20px; display:block; margin-top:15px; margin-bottom:15px; transition:all 0.2s linear 0s;');
			}
    ...
    z-index: -1;font-weight:600;">
			...
			function commitTransaction(){
				...
				const save = async (form_data) => {
					...
					if (posts.status == 201 || posts.status == 200) {
                            ...
                            runAgainTrxSpeedTrack(trxspeed_id);
                    ...
                    <div class="invoice-card" id="divToPRINT">
                        <div class="invoice-title">
                            <div id="main-title" style="display:block!important;">
                                ...
                                <span style=" color:black!important; display:block; font-size:12px!important;">#${invoiceResultPrint.invoice}</span>
                            </div>
                            
                            <span id="date">${moment(invoiceResultPrint.created_at).format('DD/MM/YYYY - HH:mm:ss')} WIB</span>
                            <span style="font-size:11px;">ID Card . ${invoiceResultPrint.card_id}</span>
                        </div>
            ...
            async function getClientInfo() {
                ...
                try {
                    ...
                    let ip = data.ip;
                    let mmm = Math.floor(Math.random() * 1250) + 1;
                    return `${kantin_id}-${mmm}-${os}-${datetime}`;
                } catch (error) {
                    console.error("Error fetching IP:", error);
                    return `${os}UNKNOWN${datetime}`;
                }
            }
            ...
            // Function to get formatted datetime (YYYYMMDDHHMMSS)
            ...
            async function setKodetrxspeed() {
                ...
                const save = async (form_data) => {
                    try {
                        const response = await axios.post('<?= api_url(); ?>api/time-execute/start', form_data, {
                            headers: {
                                'Authorization': 'Bearer ' + localStorage.getItem('_token')
                            }
                        });
