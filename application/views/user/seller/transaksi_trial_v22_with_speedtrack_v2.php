		...
		<div class="modal fade" id="modalSetCard" tabindex="-1" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
			<div class="modal-dialog modal-dialog-centered">
                ...
                padding: 0.5em;">
                    ...
                    <font class="px-3" style="display:block; text-align:center; margin:auto; font-size:12px; letter-spacing:2px; padding:5px; background:#000;color:white; border-radius:100px; margin-bottom:-24px; margin-top:10px;">Version 22 (2)</font>
				</div>
			</div>
		</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
		...
		<script type="text/javascript">
            ...
            function submitPembelian(str){
                ...
                const save2 = async () => {
					const posts2 = await axios.get('<?= api_url(); ?>api/v1/key/create-trx-cache', {
						headers: {
							'Authorization': 'Bearer ' + localStorage.getItem('_token')
						}
					}).catch((err) => {
            ...
            function searchSiswaByKartu(str){
                ...
                const save2 = async () => {
					const posts2 = await axios.get('<?= api_url(); ?>api/v1/usr-inquery?card='+str, {
						headers: {
							'Authorization': 'Bearer ' + localStorage.getItem('_token')
						}
					}).catch((err) => {
            ...
            function goUpdateKey(key){
                ...
                form_data.append('prefix', 'usr_cache');
