<style type="text/css">
    ...
    .alsss2 {
        position: sticky;
        bottom: 100px; /* Adds 100px space from the top of the viewport */
        /* background-color: #f2f2f2; Background color to prevent transparency */
        border-radius:10px;
        z-index: 1000; /* Ensures it stays above other content */
        padding: 0px;
					...
					<div class="card-body">
						<ul class="nav nav-pills mb-3" role="tablist">
							<li class="nav-item" role="presentation">
								<a class="nav-link menu1 active" data-bs-toggle="pill" href="#primary-pills-home" role="tab" aria-selected="false">
							...
							<li class="nav-item menu2 " role="presentation">
								<a class="nav-link" data-bs-toggle="pill" href="#primary-pills-profile" role="tab" aria-selected="true" tabindex="-1">
									<div class="d-flex align-items-center">
							...
							<div class="tab-pane fade active show " id="primary-pills-home" role="tabpanel">
								<div class="row">
									...
									<div class="col-lg-6 col-12">
											<button type="button" class="btn btn-success btnselesaitransaksi" data-value="" onclick="submitPembelian('pembelian');" style="width:100%;padding:13px;">SELESAIKAN TRANSAKSI</button>
											
									</div>
								</div>
							</div>
							<div class="tab-pane  " id="primary-pills-profile" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-12 mb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="row text-center" style="position: fixed;
                                                    width: 30%;
                                                    bottom: 0;
                                                    background: #fff;
		...
		<script type="text/javascript">
            ...
            function handleEnter(event) {
                if (event.key === 'Enter') {
                    ...
                    let totalx = $('.display').val().replace(/\./g, '').replace(',', '.'); // Hilangkan pemisah ribuan dan ubah koma ke titik
            ...
            function loadMenu() {
                ...
                const save2 = async () => {
                    ...
                    if (posts2.status == 200) {
                        ...
                        let categoryButtons = `<swiper-container style="" class="mySwiper" pagination="true" pagination-clickable="true" space-between="30" slides-per-view="6" navigation="false">
                        ...
                        function renderItems(category) {
                            ...
                            Object.keys(groupedData).sort().forEach(letter => {
                                ...
                                if (filteredItems.length) {
                                    ...
                                    let thumbnail = 'https://png.pngtree.com/png-vector/20190726/ourlarge/pngtree-food-icon-design-vector-png-image_1608882.jpg';
                                    filteredItems.forEach(mapping => {

                                        if(mapping.gambar!='undefined'){
                                            thumbnail = `<?=api_url();?>${mapping.gambar}`;
                                        }else {
                                            thumbnail = 'https://png.pngtree.com/png-vector/20190726/ourlarge/pngtree-food-icon-design-vector-png-image_1608882.jpg';
                                        }
                                        sintaks += `
                                        <div class="col-md-3 col-lg-3 col-sm-4 col-6 text-center itemnya" onclick="addToCart('${mapping.id}')" style="padding:7px;">
                                            <div class="card-body" style="padding:0px;padding-top:10px;margin:0px;border:1px solid #ccc; border-radius:10px;padding-bottom:10px;">
                                                <img src="${thumbnail}" style="width:130px; height:85px; display:block;margin:auto; object-fit:cover; border-radius:10px;"/>
