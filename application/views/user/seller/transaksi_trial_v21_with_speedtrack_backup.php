...
z-index: -1;font-weight:600;">
    ...
    z-index: -1;font-weight:600;">
            ...
            function goUpdateKey(key){
                var form_data = new FormData();
                form_data.append('key', key);
                form_data.append('prefix', 'usr');
                // Function to send data
                const save = async (form_data) => {
                    try {
                        const response = await axios.post('<?= api_url(); ?>api/monitoring/end-monitorig-time-execute', form_data, {
                            headers: {
                                'Authorization': 'Bearer ' + localStorage.getItem('_token')
                            }
                        });
                    ...
                    <div class="invoice-card" id="divToPRINT">
                        <div class="invoice-title">
                            <div id="main-title" style="display:block!important;">
                                ...
                                <span style=" color:black!important; display:block; font-size:12px!important; text-align:center;">#${invoiceResultPrint.invoice}</span>
                            </div>
