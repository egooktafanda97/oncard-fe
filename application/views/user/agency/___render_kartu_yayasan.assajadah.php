            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let displayText = textNamaA.trim();
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="     width: 204px;
    height: 274px;
    border-radius: 6px;
...
<p style="margin:0px!important;font-size:15px; color:#027b50;font-weight:900; margin-top:5px!important; line-height:1em;">${displayText}</p>
                                            <!---<p  style="margin:0px!important; margin-top:4px!important;text-transform:uppercase; color:white;text-transform:uppercase;font-size:11px;line-height:1em;">${keteranganText} PONDOK PESANTREN AL MUSLIMUN</p>--->
                                            <p  style="margin:0px!important;text-transform:uppercase; margin-top:6px!important;     color:#fff;font-size: 15px;
letter-spacing: 1px;">${mapping.kode} ${keteranganText}</p>
