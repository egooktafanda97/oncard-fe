...
<div class="row">
            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let urlBgDepanSiswaMTS = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_muda.webp';
                        
                        let urlBgDepanSiswaMA= '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_muda.webp';
                        
                        let urlBgDepanGeneral = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_muda.webp';
                        ...
                        console.log("foto bg : ",putKartuImage);
                        ...
                        tableColumn +=`
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url('${urlBgDepanSiswaMTS}');background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="    width: 126px;
    height: 134px;
    border-radius: 25px;
    ...
    font-size: 16px;
    text-align: center;">
                                            <p style="font-weight:900;margin:0px!important;text-transform:uppercase;font-size:20px;margin-top:20px!important; color:#000; line-height:1em;">${textNama[0]}</p>
                                            <p  style="margin:0px!important;text-transform:uppercase; margin-top:0px!important;     color:#000;font-size: 19px;
letter-spacing: 1px;">${mapping.kode}</p>
