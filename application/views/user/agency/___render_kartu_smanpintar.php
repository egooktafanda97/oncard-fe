...
<div class="row">
					...
					if (posts2.status == 200) {
                        ...
                        let htmlx = '';
                            ...
                            posts2.data.data.map((mapping,i)=>{
                                ...
                                let textNama = textNamaA.split("-SM");
            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let urlBgDepanSiswaMA= '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_sma_'+lastSegment+'.webp';
                        
                        let urlBgDepanGeneral = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_sma_'+lastSegment+'.webp';
                        ...
                        if(lastSegment!=4){
                            if(mapping.keterangan=='SMA'|| mapping.keterangan=='Madrasah Tsanawiyah'){
                                tableColumn +=`
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                            <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="width: 144px;
        height: 192px;
        border-radius: 6px;
    ...
    font-size: 16px; text-align:center;">
                                                ...
                                                <p  style="margin:0px!important;text-transform:uppercase; margin-top:0px!important;     color:#000;font-size: 15px;
    letter-spacing: 1px;">${mapping.kode} | SISWA</p>
        ...
        text-align: center;
                            ...
                            tableColumn +=`
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                            <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="    width: 175px;
    height: 180px;
    border-radius: 30px;
    border: -2px solid #fff;
    position: relative;
    ...
    text-align: center;
    ">
                                                <p style="margin:0px!important;text-transform:uppercase;font-size:15px;font-weight:900; color:#000; line-height:1em;">${textNama[0]}</p>
                                                <p  style="margin:0px!important;text-transform:uppercase; margin-top:0px!important;     color:#000;font-size: 12px;
    letter-spacing: 1px;font-weight:500;">${mapping.kode}</p>
    <p  style="margin:0px!important;text-transform:uppercase; margin-top:0px!important;     color:#000;font-size: 12px;
    letter-spacing: 1px;font-weight:500;">${mapping.alamat}</p>
