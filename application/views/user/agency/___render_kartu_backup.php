			...
			function showData(){
				...
				const save2 = async () => {
					...
					if (posts2.status == 200) {
                            ...
                            let maLengkapAll = dataMALengkap +dataMATidakLengkap + 1;
                            let mtsLengkapAll = dataMtsLengkap +dataMtsTidakLengkap;

                        $('.resumeData').html(`
                            <table class="table table-bordered">
                                <tr>
                                <td width="33.3%"><font class="jmldataok"></font><a href="#/" onclick="showModalData();">Lihat ${arr.length} data yang belum lengkap</a><br/>Data MA (${dataMATidakLengkap}) | Data MTS (${dataMtsTidakLengkap})</td>
                                <td width="33.3%">${dataokcount} data sudah lengkap<br/>Data MA (${dataMALengkap+1}) | Data MTS (${dataMtsLengkap})</td>
                                <td width="33.3%"> TOTAL DATA : ${posts2.data.data.length} DATA.<br/>Data MA (${maLengkapAll}) | Data MTS (${mtsLengkapAll})</td>
                                </tr>
                            </table>
                        `);
