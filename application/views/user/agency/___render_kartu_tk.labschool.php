                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="     width: 149px;
    height: 158px;
    border-radius: 28px;
...
<p style="margin:0px!important;font-size:20px; color:#23285b;font-weight:900; margin-top:25px!important; line-height:1em;">${displayText}</p>
                                            <p  style="margin:0px!important; margin-top:0px!important; font-weight:normal; color:#23285b;font-size: 17px;
letter-spacing: 0px;">${mapping.nama_orangtua} Class</p>
