            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let urlBgDepanGeneral = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/template_general_new.webp';
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="width: 152px;
height: 195px;
border-radius: 3px;
...
font-size: 16px; text-align:center;">
                                            <p style="margin:0px!important;text-transform:uppercase;font-size:20px; color:#126607; line-height:1em;">${textNama[0]}</p>
                                            <p  style="margin:0px!important; margin-top:4px!important;text-transform:uppercase; color:#126607;text-transform:uppercase;font-size:15px;line-height:1em;">${alamat} , ${moment(mapping.tgllahir).format('DD-MM-YYYY')}</p>
                                            <p  style="margin:0px!important;text-transform:uppercase; margin-top:10px!important;     color:#126607;font-size: 15px;
letter-spacing: 2px;">NIK ${mapping.kode}</p>
<p  style="margin:0px!important;text-transform:uppercase; margin-top:6px!important;     font-size: 15px;
letter-spacing: 2px;color:#126607">STNBK ${mapping.nama_orangtua}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="    width: 187px;
    height: 235px;
    border-radius: 3px;
    border: -2px solid #fff;
    position: relative;
    ...
    text-align: center;
                                            ...
                                            <p style="margin:0px!important;font-size:18px; color:#126607; line-height:1em;">${textNama[0]}</p>
                                            <p  style="margin:0px!important; margin-top:4px!important;text-transform:uppercase; color:#126607;text-transform:uppercase;font-size:11px;line-height:1em;">${keteranganText} PONDOK MODERN AL-KAUTSAR</p>
                                            <p  style="margin:0px!important; margin-top:4px!important;text-transform:uppercase; color:#126607;text-transform:uppercase;font-size:15px;line-height:1em;">${mapping.nama_orangtua}</p>
