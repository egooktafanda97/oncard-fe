			...
			$(document).ready(function () {
                ...
                $(".date-range").flatpickr({
                    ...
                    onClose: function(selectedDates, dateStr, instance){
                        ...
                        if(dateStr.length==1){
                            urlSetFromFilter += '&date_from='+dateStr[0]+'&date_to='+dateStr[0];
                        }else {
                            urlSetFromFilter += '&date_from='+dateStr[0]+'&date_to='+dateStr[1];
                        }
                        showData();
                    }
                });
				...
				const save2 = async () => {
					...
					if (posts2.status == 200) {
                            ...
                            posts2.data.data.map((mapping,i)=>{
                                ...
                                let namaNya = '';
                                let amount =mapping.credit_amount??'0';
