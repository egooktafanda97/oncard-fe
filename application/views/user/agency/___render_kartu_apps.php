...
<div class="row">
        ...
        <script type="text/javascript">
					...
					if (posts2.status == 200) {
                        ...
                        let htmlx = '';
                            ...
                            posts2.data.data.map((mapping,i)=>{
                                ...
                                <tr class="mpr${mapping.user.id}" style="cursor:pointer;" onclick="putToQueueSide(${mapping.user.id},'${namaNya}','${mapping.nis}','${mapping.tempat_lahir}','${mapping.tanggal_lahir}','${textTingkat}','${mapping.user.foto}');$(this).css('opacity','0.4');">
                                            <td width="50">
                        ...
                        let htmlx = '';
                            ...
                            posts2.data.data.map((mapping,i)=>{
                                ...
                                htmlx +=`
                                        ...
                                        <tr class="mpr${mapping.user.id}" style="cursor:pointer;" onclick="putToQueueSide(${mapping.user.id},'${namaNya}','','${alamatNya}','${mapping.tanggal_lahir}','${tingkatNya}','${mapping.user.foto}');$(this).css('opacity','0.4');">
                                            <td width="50">
                                                <img src="<?=base_url();?>app/assets/users/foto/${mapping.user.foto}" style="width:16px; height:27px; border-radius:2px; position:relative;object-fit:cover; object-position:center;"/>
                                            </td>
                                            <td width="300" class="${(sttsgambar==false)?'text-danger':''}">
            ...
            function putToQueueSide(id,nama,kode,alamat,tgllahir,keterangan,foto){
            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let urlBgDepanSiswaMTS = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_mts.webp';
                        
                        let urlBgDepanSiswaMA= '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_ma.webp';
                        
                        let urlBgDepanGeneral = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_general.webp';
                        ...
                        if(userNameX=='tafaqquh'){

                                if(mapping.keterangan=='Madrasah Aliyah'|| mapping.keterangan=='Madrasah Tsanawiyah'){
                                    tableColumn +=`
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                                    <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="width: 144px;height: 194px;border-radius: 5px;/* border:4px solid #fff; */position:relative;margin-left: 103px;margin-top: 207px;object-fit:cover;object-position: center;"/>
                                                    <div style="width: 350px;margin-left: 0px;margin-top: 8px;color:black;font-weight:bold;font-size:16px;text-align: center;">
                                                        <p style="margin:0px!important;text-transform:uppercase;">${textNama[0]}</p>
                                                        <p  style="margin:0px!important;margin-top: -6px!important;font-size: 13px;font-weight: lighter;text-transform:uppercase;">SANTRI | ${mapping.kode}</p>
                                                        <p  style="margin:0px!important;margin-top: -6px!important;font-size: 13px;font-weight: lighter;text-transform:uppercase">${moment(mapping.tgllahir).format('DD MMMM YYYY')}</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                                    <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="width: 144px;height: 194px;border-radius: 5px;/* border:4px solid #fff; */position:relative;margin-left: 103px;margin-top: 207px;object-fit:cover;object-position: center;"/>
                                                    <div style="width: 350px;margin-left: 0px; margin-top: 8px;color:black;font-weight:bold;font-size:16px;text-align: center;">
                                                        <p style="margin:0px!important;">${textNama[0]}</p>
                                                        <p  style="margin:0px!important;margin-top: -6px!important;font-size: 13px;font-weight: lighter;">${mapping.kode}</p>
                                                        <p  style="margin:0px!important;margin-top: -6px!important;font-size: 13px;font-weight: lighter;text-transform:uppercase;">${mapping.keterangan}</p>
                                ...
                                if(mapping.keterangan=='Madrasah Aliyah'|| mapping.keterangan=='Madrasah Tsanawiyah'){
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                                <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="width:143px; height:187px; border-radius:20px; border:4px solid #fff; position:relative; margin-left:105px; margin-top:149px; object-fit:cover; object-position:center;"/>
                                                <div style="width:250px; margin-left:102px; margin-top:-1px; color:black; font-weight:bold; font-size:16px;">
                                                    ...
                                                    <!---<p  style="margin:0px!important; margin-top:-4px!important;margin-left:-40px!important;margin-bottom:1px!important; font-size:15px;"><font style="font-size:14px!important;margin-right:5px!important">/NIK</font> ${mapping.kode}</p>--->
                                                    <p  style="margin:0px!important; margin-top:-3px!important; font-size:15px;">${mapping.kode}</p>
                                                    <p  style="margin:0px!important; margin-top:-4px!important;text-transform:capitalize;font-size:15px;">${alamat} , ${moment(mapping.tgllahir).format('DD-MM-YYYY')}</p>
                                    ...
                                    textNama[0] = convertToUpperCaseBeforeComma(textNama[0]);
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                                    ...
                                                    <div style="width:250px; margin-left:122px; margin-top:-1px; color:black; font-weight:bold; font-size:16px;">
                                                        <p style="margin:0px!important;">${textNama[0]}</p>
                                                        <p  style="margin:0px!important; margin-top:-3px!important; font-size:15px;">${keteranganText}</p>
