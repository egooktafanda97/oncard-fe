...
<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Tambah Pengguna Membership</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
                                <li class="breadcrumb-item"><a href="<?=base_url().$function;?>/Membership">Daftar Pengguna</a>
								</li>
				  ...
				  <div class="card-body p-4">
					  ...
					  <hr/>
                       ...
                       <div class="alert alert-warning">
                        <h4>Perhatian!</h4>
                        Sebelum mendaftarkan pengguna baru, Perli diingat bahwa Membership ini diharuskan untuk membeli Kartu Membership terlebih dahulu sesuai dengan harga yang telah diketahui oleh Pihak Instansi dan Oncard.id.<br/>
        ...
        <script type="text/javascript">
			...
			function addData() {
				...
				var jabatan = 'membership';
				var noTelp = $("#noTelp").val();
				
				var form_data = new FormData();
				
				if(jabatan=='Guru'){
					form_data.append('mata_pelajaran', 'membership');
				}
