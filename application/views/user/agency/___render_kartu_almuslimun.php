                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="        width: 147px;
    height: 207px;
    border-radius: 6px;
...
<p style="margin:0px!important;font-size:18px; color:white; line-height:1em;">${textNamaA}</p>
                                            ...
                                            <p  style="margin:0px!important;text-transform:uppercase; margin-top:0px!important;     color:#fff;font-size: 15px;
