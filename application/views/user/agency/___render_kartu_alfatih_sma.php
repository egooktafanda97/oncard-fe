            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let urlBgDepanSiswaMTS = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_sma_1.png';
                        
                        let urlBgDepanSiswaMA= '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_sma_1.png';
                        
                        let urlBgDepanGeneral = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_sma_1.png';
                        ...
                        }else if(mapping.keterangan=="SMP"){
                        ...
                        let clearnis = mapping.kode;
                            let newStr = clearnis.replace(/\./g, "");

                        if(mapping.keterangan=='SMA'|| mapping.keterangan=='SMP'){
                            ...
                            <div class="row">
                                ...
                                <div style="
                                    ...
                                    height: 553.02px !important;
                                    margin-bottom: 50px;
                                    margin-right: 50px;
                                    background: url(${putKartuImage});
                                    ...
                                    align-items: center;
                                    justify-content: center;
                                    page-break-before: always; /* Ensures a new page for each card */

                                    ">
                                    
                                    <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="
                                        width: 250px;
                                        height: 250px;
                                    ...
                                    <div style="
                                        ...
                                        <p style="margin: 0px !important; text-transform: uppercase; font-size: 18px; color: #084f38; line-height: 1em;">
                                            ${textNama[0]}
                                        </p>
                                        
                                        <p style="font-weight: normal; margin: 0px !important; text-transform: uppercase; color: #084f38; font-size: 15px; letter-spacing: 1px;">
                                            ${newStr} | SISWA
                                        </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <div style="    width: 347px !important;
    height: 553.02px !important;margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="
                                        width: 250px;
                                        height: 250px;
                                        border-radius: 6px;
                                        ...
                                        font-size: 14px;
                                        text-align: center;">
                                            <p style="margin:0px!important;text-transform:uppercase;font-size:20px; color:#084f38; line-height:1em;">${textNama[0]}</p>
                                            <p  style="font-weight:normal;margin:0px!important;text-transform:uppercase; margin-top:0px!important;  color:#084f38;font-size: 15px;
                                            letter-spacing: 1px;">${newStr} | SISWA</p>
