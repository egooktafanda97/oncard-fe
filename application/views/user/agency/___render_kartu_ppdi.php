            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let urlBgDepanSiswaMA= '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_mts.webp';
                        
                        let urlBgDepanGeneral = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_mts.webp';
...
font-size: 16px; text-align:center;">
                                            <p style="margin:0px!important;text-transform:uppercase;font-size:20px; color:#000; line-height:1em;">${textNama[0]}</p>
                                            <p  style="margin:0px!important;text-transform:uppercase; margin-top:0px!important;     color:#000;font-size: 15px;
letter-spacing: 1px;">${mapping.keterangan}</p>
