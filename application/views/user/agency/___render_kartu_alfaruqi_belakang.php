...
<div class="row">
            <div class="col-lg-3 col-md-3 col-12 p-3 ps-4" style="min-height:100vh;max-height:100vh;background:#fff!important;display:block;overflow-y:scroll;">
                <h5>MASUKKAN KE ANTRIAN FARUQI - BELAKANG: </h5>
                <div class="row">
                    <div class="col-md-12">
            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        if(lastSegment=='2'){
                            urlBgDepanSiswaMTS = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/belakang_smp_faruqi.webp';
                        }else if(lastSegment=='3') {
                            urlBgDepanSiswaMTS = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/belakang_sma_faruqi.webp';
                        }else {
                            urlBgDepanSiswaMTS = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_web_ma.webp';
                        }
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        <img src="<?=base_url();?>app/assets/users/foto/${mapping.foto}" style="    width: 0;
    height: 0;
    border-radius: 30px;
    position: relative;
    margin-left: 88px;
    ...
    font-size: 19px;
    text-align: left;">
<p style="margin:0px!important;font-size:12px; color:#000;font-weight:700; line-height:1.4em;">
${mapping.kode}<br/><br/>
${displayText}
<br/><font style="margin-top:-1px;display:block;">${mapping.alamat}</font>
</p>
