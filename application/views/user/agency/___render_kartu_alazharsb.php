            ...
            function getnow(){
                ...
                datam.map((mapping,i)=>{
                    ...
                    inisiateNama = inisiateNama.toLowerCase();
                        ...
                        let urlBgDepanSiswaMTS = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_smp.webp';
                        
                        let urlBgDepanSiswaMA= '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_sma.webp';
                        
                        let urlBgDepanGeneral = '<?=base_url();?>assets_oncard/images/kartu/foto_kartu_'+userNameX+'/front_siswa_smp.webp';
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div style="width:350px!important; height:555.02px!important; margin-bottom:50px; margin-right:50px; background:url(${putKartuImage});background-size:contain;background-position:center;">
                                        ...
                                        font-size: 14px;
                                        text-align: center;">
                                            <p style="margin:0px!important;text-transform:uppercase;font-size:20px; color:#fff; line-height:1em;">${textNama[0]}</p>
                                            <p  style="font-weight:normal;margin:0px!important;text-transform:uppercase; margin-top:0px!important;  color:#fff;font-size: 15px;
                                            letter-spacing: 2px;">NISN ${mapping.kode}</p>
