...
<div class="page-wrapper">
        ...
        <div class="modal fade" id="modalReleaseCardNew" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                    <label for="pinOto" class="form-label">Pin Siswa</label>
        ...
        function setModePelepasan() {
            ...
            if(parseInt(saldo_now) < 35000 && modesett_up!='malfungsi'){
                Swal.fire({
                    icon: "error",
		...
		<script type="text/javascript">
							...
							tableColumn +=`
								<tr>
									...
									<td>
                                        ...
                                        ${(mapping.accounts?.card_id==null)?`<a href="#/" onclick="openmodalSetCard('connect');idsett='${mapping.accounts?.account_number}';" class="me-3 "><i class='bx bx-link'></i></a>`:`<a href="#/" onclick="openmodalReleaseCardNew();idsett='${mapping.accounts?.account_number}';useridsett='${mapping.user_id}';saldo_now='${mapping.accounts?.balance??0}';pinsett='${mapping.accounts.pin}'" class="me-3 text-danger"><i class='bx bx-unlink'></i></a>`} 
            ...
            $('#modalSetSaldoEdupay').on('hidden.bs.modal', function () {
                // $('#modalSetCard').modal('toggle');
                if(!$('#modalSetSaldo').hasClass('show')){
                    notelppublic = '';
                }else {
