<div class="page-wrapper">
			<div class="page-content">
                ...
                <div class="card" style="border-radius:100px;">
                    <div class="card-body">
                    <input type="text" maxlength="10" placeholder="Scan kartu" style="margin:auto; text-align:center; width:100%; border:1px solid;outline:none!important; border-radius:100px; padding:10px; font-size:25px; font-weight:bold;" id="textToCard"/>
                    </div>
                </div>
				<div class="card">
					<div class="card-body">
						<div class="">
                            <h4>50 Kartu Terbaru</h4>
