				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="<?=base_url().$function.'/tambahAgensi';?>" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Tambah Agensi</a></div>
						</div>
				...
				const save2 = async () => {
					...
					if (posts2.status == 200) {
                        ...
                        console.log(posts2.data.data);
                            ...
                            totals2 += parseInt(mapping.punyaontuition??0);
							tableColumn +=`
								<tr>
									<td>
									...
									<td style="word-wrap: break-word!important;min-width: 160px;max-width: 160px;white-space: normal !important;">Rp${formatRupiah(mapping.punyaoncard??'0')}</td>
									<td style="word-wrap: break-word!important;min-width: 160px;max-width: 160px;white-space: normal !important;">Rp${formatRupiah(mapping.punyaontuition??'0')}</td>
									<td>
                        ...
                        $('.putContentHere').html(tableColumn);
                        $('.footerContentHere').html(`
                        <tr style="font-size:15px;font-weight:bold;">
                            <td colspan="5" style="font-weight:900;">TOTAL</td>
                            <td colspan="1">Rp${formatRupiah(totals.toString())}</td>
                            <td colspan="2">Rp${formatRupiah(totals2.toString())}</td>
                        </tr>`);
