...
<div class="page-wrapper">
	...
	<script type="text/javascript">moment.locale('id');</script>
        ...
        <script type="text/javascript">
            ...
            const save2 = async () => {
                const posts2 = await axios.get('<?=base_url(); ?>CPanel_Admin/getDataAgensiAllIpaymuByMonth/2025-05/11').catch((err) => {
                    console.log(err.response);
                });
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        Dibuat: ${moment(str).format('DD MMMM YYYY')}<br />
                                                        Perlu dibayar: ${moment(str).format('DD MMMM YYYY')}
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
            ...
            function setShowData(str){
                ...
                const save2 = async () => {
					const posts2 = await axios.get('<?=base_url(); ?>CPanel_Admin/getDataAgensiAllIpaymu/'+str).catch((err) => {
						console.log(err.response);
					});
