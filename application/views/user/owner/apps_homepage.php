			...
			<div class="page-content">
                ...
                <div class="container min-vh-60 d-flex justify-content-center align-items-center">
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="card shadow-sm border-0 rounded-4" style="margin-top:-50px;">
                            <div class="card-body p-4">
                                <h4 class="text-center mb-4 fw-bold">Login<br/>
                                <font style="font-weight:900">SNAP BI DEV</font></h4>
                                <form>
                                    <div class="mb-3">
            ...
            $('#btnSbmtReg').on('click', function (event) {
                event.preventDefault();
                    ...
                    const ajaxAxiosLogin = async () => {
                        const login = await axios.post("<?= base_url('Login/LoginApps') ?>", form_data).catch((err) => {
                            // kesalahan login
                        ...
                        if(login.data.status==401||login.data.status==402){
                            ...
                            sessionStorage.setItem('_token_apps', login.data.result.data.token);
                            localStorage.setItem('_token_apps', login.data.result.data.token);

                            window.location.href = "<?= base_url('CPanel_Admin/AppsNext') ?>";
