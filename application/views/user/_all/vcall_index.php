  ...
  <body>
    ...
    <script>
        ...
        joinButton.addEventListener("click", () => {
            ...
            window.VideoSDK.config("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcGlrZXkiOiJhZTRjNTNhMS04Y2RmLTRjYmEtYTcwNi04MDVlMGIwNGExZmIiLCJwZXJtaXNzaW9ucyI6WyJhbGxvd19qb2luIl0sImlhdCI6MTcwMTY2Nzc0OCwiZXhwIjoxNzAxNzU0MTQ4fQ.SHPtPHnpttBBQ76pkwPAYCA8H0G6M7b4jsmAnOXKBc0") // required;
            meeting = window.VideoSDK.initMeeting({
            meetingId: "6efl-x24k-3vid", // required
            name: "Ridho's Org", // required
