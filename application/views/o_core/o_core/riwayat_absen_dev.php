                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-info p-3" style="overflow:hidden;">
                                        ...
                                        <button type="button" id="hits-button-siswa-tidak-absen" class="btn btn-sm btn-primary d-block" style="border-radius:3px!important;">Lihat Daftar Guru/Staf Tidak Absen Masuk Sekolah</button>
                                        <button type="button" id="hits-button-siswa-tidak-absen-kelas" class="btn btn-sm btn-info d-block mt-3" style="border-radius:3px!important;">Lihat Daftar Guru/Staf Tidak Absen Masuk Kelas</button>
