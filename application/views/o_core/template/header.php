...
<head>
    ...
    .btn-success {
        background: #10A0A2!important;
        background: linear-gradient(90deg, rgba(16, 160, 162, 1) 0%, rgba(16, 160, 162, 1) 40%, rgba(88, 196, 114, 1) 100%)!important;
    }
    .btn-primary {
        background: #71b734;
background: linear-gradient(90deg, rgba(113, 183, 52, 1) 0%, rgba(35, 148, 99, 1) 50%, rgba(52, 183, 126, 1) 100%);
    }
