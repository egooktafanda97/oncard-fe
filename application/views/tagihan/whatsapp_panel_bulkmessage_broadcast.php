                                ...
                                <div class="card-body">
                                    <div class="row align-items-start">
                                        ...
                                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            ...
                                            <button class="nav-link" style="text-align:left;" id="v-pills-home-tab3" data-bs-toggle="pill" data-bs-target="#v-pills-home3" type="button" role="tab" aria-controls="v-pills-home3" aria-selected="true" onclick="setContent('v-pills-home3');">Broadcast Inisiasi Sistem Tagihan</button>
                                ...
                                <div class="row jumbotron">
                                    <div class="col-12">
                                        <div class="alert alert-success" role="alert">
                                            Sistem akan mengirim broadcast kepada <b>${countData}</b> nomor orangtua santri. Klik tombol <b>KIRIM BROADCAST</b> dibawah ini untuk mengeksekusi pengiriman secara massal sekarang juga.
                                        </div>
                                    </div>
...
_Kode pesan : #${createRandom()}_
            ...
            function sendMessageNow(){
                ...
                let modul = totalAllTarget / rentang;
                modul = Math.ceil(modul);
                
                for(let mx = 0 ; mx < modul; mx++){ // rentang 0 - 5 // 480 data terakhir kirim
                    ...
                    (function(mx){
                        ...
                        window.setTimeout(function(){
                            ...
                            if(modeSett=='sendGeneral'){
                                pesan = $('.putPesanHereGeneral').val();
                            }else {
                                pesan = $('.putPesanHereSiswa').val();
                            }
                            ...
                            form_data.append('endPoint','PesanInisiasiTagihan');
                            form_data.append('pesan',pesan);
                            
                            jQuery.ajax({
                                type: "POST",
                                url: "<?php echo base_url(); ?>"+"WebhookOncard/sendBroadcastBerkalaKustom/467.598.080",
                                cache: false,
                                contentType: false,
                                processData: false,
                                data: form_data,
                            ...
                            console.log(mx, parseInt(modul-1));
